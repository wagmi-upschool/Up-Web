      ...
      <div className="relative z-10 bg-white px-6 py-4 shadow-sm">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center">
            <h1 className="font-righteous text-xl text-title-black mb-1">Test</h1>
            <p className="font-poppins text-sm text-text-light mb-3">Test / Sınav - değerlendirme</p>
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-poppins text-text-light">
                0 cevaplandı
              </span>
            </div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <span className="font-poppins text-xs text-text-body-black min-w-fit">İlerliyoruz</span>
